...
pragma table_info(account_opportunities);
cid   name        type      notnull   dflt_val  pk
----  ----------  --------  --------  --------  --------
0     id          INTEGER   1                   1
1     account_id  integer   0                   0
...
pragma table_info(field_groups);
cid   name        type      notnull   dflt_val  pk
----  ----------  --------  --------  --------  --------
0     id          INTEGER   1                   1
1     name        varchar(  0                   0
...
pragma table_info(ar_internal_metadata);
cid   name        type      notnull   dflt_val  pk
----  ----------  --------  --------  --------  --------
0     key         varchar   1                   1
1     value       varchar   0                   0
...
pragma table_info(groups_users);
cid   name        type      notnull   dflt_val  pk
----  ----------  --------  --------  --------  --------
...
pragma table_info(contact_opportunities);
cid   name        type      notnull   dflt_val  pk
----  ----------  --------  --------  --------  --------
0     id          INTEGER   1                   1
